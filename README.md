...
관심종목 등록 여부와 무관하게 전체 종목을 대상으로, 실적·자본변동·자사주·
배당·M&A·리스크 계열의 중요한 전자공시(DART)가 새로 등록되면 휴대폰 푸시
알림으로 알려줍니다. GitHub Actions에 평일 09:00~15:50(KST), 10분 간격으로
조회하도록 설정했습니다. 실제 실행 시각은 스케줄러 상황에 따라 지연될 수
있습니다.
